...
time.stopwatch = (function() {
    // private state
    var minuteSpan, secondSpan, msSpan;
    var timer;
    ...
    var tickStopwatch = function() {
        ...
        minuteSpan.text(utility.padSingleDigit(elapsed.minutes));
        secondSpan.text(utility.padSingleDigit(elapsed.seconds));
        msSpan.text(elapsed.milliseconds);
    };

    // public methods
    return {
        start: function(mSpan, sSpan, mlSpan) {
            minuteSpan = mSpan,
                secondSpan = sSpan,
                msSpan = mlSpan;
